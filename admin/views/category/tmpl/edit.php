<?php
/**
 * MyPortfolio Administrator category edit form
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_myportfolio&layout=edit&id='.(int) $this->item->id, false); ?>" method="post" name="adminForm" id="category-form" class="form-validate">
    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_MYPORTFOLIO_NEW_CATEGORY') : JText::sprintf('COM_MYPORTFOLIO_EDIT_CATEGORY')); ?>
        <div class="row-fluid">
            <div class="span9">
